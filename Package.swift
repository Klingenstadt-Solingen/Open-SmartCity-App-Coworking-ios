...
let package = Package(
  ...
  targets: [
    ...
    .target(
      name: "OSCACoworking",
      dependencies: [.product(name: "OSCAEssentials",
      ...
      path: "OSCACoworking/OSCACoworking",
      exclude: ["Info.plist"],
      resources: [.process("Resources")]
    ),// end target
    .testTarget(
      name: "OSCACoworkingTests",
      dependencies: [ "OSCACoworking",
      ...
      path: "OSCACoworking/OSCACoworkingTests",
      exclude: ["Info.plist"],
      resources: [.process("Resources")]
    )// end testTarget
  ]// end targets
