...
public enum OSCACoworkingError: Swift.Error, CustomStringConvertible {
...
}// end public enum OSCACoworkingError

extension OSCACoworkingError: Equatable{
  public static func == (lhs: OSCACoworkingError, rhs: OSCACoworkingError) -> Bool {
    switch (lhs, rhs) {
...
}// end extension public enum OSCACoworkingError
